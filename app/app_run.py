...
class StartWindow(WindowInterface, Functions):
    ...
    def _createButtons(self) -> None:
        ...
        self.bt_login.configure(bg="#8F00FF", font=("Arial", 15, "bold"), fg="white", 
                                activebackground="#530391", activeforeground="white", bd=0)
        ...
        self.bt_register.configure(bg="#FF003D", font=("Arial", 15, "bold"), fg="white", 
                                   activebackground="#ab022a", activeforeground="white", bd=0)
    ...
    def _createLabels(self) -> None:
        ...
        self.lb_enter.configure(bg="#0d0d0d", font=("Arial", 15, "bold"), fg="white")
        self.lb_enter.place(relx=0.25, rely=0.5, relwidth=0.5, relheight=0.06)

        self.lb_line = Label(
            self.root, text=("_" * 92))
        self.lb_line.configure(bg="#0d0d0d", fg="white", font=("verdana", 15, "bold"))
        ...
        self.lb_register.configure(bg="#0d0d0d", font=("Arial", 15, "bold"), fg="white")
        self.lb_register.place(relx=0.25, rely=0.74, relwidth=0.5, relheight=0.06)
...
class RegisterWindow(WindowInterface, Functions):
    ...
    def _createLabels(self) -> None:
        ...
        self.lb_terms.configure(bg="#0d0d0d", font=("Arial", 8, "bold"), fg="white")
        self.lb_terms.place(relx=0.25, rely=0.75, relwidth=0.5, relheight=0.07)

        self.lb_login = Label(self.root, text="Já tem uma conta?")
        self.lb_login.configure(bg="#0d0d0d", font=("Arial", 13, "bold"), fg="white")
...
class LoginWindow(WindowInterface, Functions):
    ...
    def _createButtons(self) -> None:
        ...
        self.bt_register = Button(self.root, text="Cadastrar uma conta",
                                  command=lambda: AppManager.changeWindow(
                                      actual_window=self.root, new_window=RegisterWindow())
                                      )
        self.bt_register.configure(font=("Arial", 15, "bold"), fg="white", bg="#FF003D", 
